			...
			public void actionPerformed(ActionEvent e) {
				if(Config.isBot()){
					...
					try {
						...
						mostrarError("No se ha podido realizar la conexion, prueba más tarde");
					}
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				if(Config.isBot()){
					if(Config.isVotacion()){
						mostrarError("La votación ya esta encendida");
					}else{
						iniciarVotacion();
					}
				}else{
			...
			public void actionPerformed(ActionEvent e) {
				if(Config.isBot()){
					if(Config.isVotacion()){
						...
						mostrarError("La votación tiene que estar encendida");
					}
				}else{
					mostrarError("El bot tiene que estar encendido");
				}
	...
	public static void leerConfig(String fConfig){
		...
		if(!(f.canRead())){
			try {
				...
				mostrarError("No se ha podido crear el archivo de configuración");
			}
